...
function App() {
  ...
  return (
    <div style={{ backgroundColor: "#F6F9F6" }} className="h-auto pb-16">
      <header>
        <nav className="mx-6 hidden sm:flex items-center translate-y-3 justify-between" role="navigation" aria-label="Main navigation">
        ...
        <nav className="flex sm:hidden items-center justify-between mx-2" role="navigation" aria-label="Mobile navigation">
          <div>
          ...
          <a href="https://github.com/Danraph-Technologies/Ecocruise-apk/releases/download/v1.0.0/Ecocruise-App.apk" download>
            <div>
              <button className="bg-blue-800 text-white py-1 text-sm sm:text-base border-2 border-blue-800  px-5 rounded-3xl hover:bg-transparent hover:text-blue-900 transition duration-500">
                Download App
              </button>
            </div>
          </a>
      ...
      <main>
        <section className="text-center mt-14" aria-labelledby="hero-heading">
          <p className="font-semibold text-sm sm:text-xl">
            DANRAPH <br /> E C O C R U I S E L I M I T E D
          </p>
          <h1 id="hero-heading" className="text-2xl sm:text-5xl font-bold m-5 sm:m-11">
            Keep Up with the Ride
          </h1>
          <p className="text-sm sm:text-lg  font-normal px-4">
            Experience fast, safe, and eco-friendly transportation across campus.
            Book rides, <br /> track shuttles, and reach your destination
            effortlessly.
          </p>
          <a href="https://github.com/Danraph-Technologies/Ecocruise-apk/releases/download/v1.0.0/Ecocruise-App.apk" download>
            <button className="py-2 px-4 my-7 cursor-pointer text-sm sm:text-lg  bg-blue-800 border-blue-800 text-white font-medium rounded-3xl hover:bg-transparent hover:text-blue-900 border-2  transition duration-500">
              Download Danraph App
            </button>
          </a>
        </section>
        ...
        <div className="flex sm:gap-7 gap-7 flex-wrap justify-between small:justify-center m-3 sm:m-5 ">
          <div className="relative text-white bg-black max-w-[390px] rounded-t-[120px]  ">
            <div className="pt-16 px-6">
              <h2 className=" font-bold text-xl sm:text-3xl">
                Seamless Campus Rides, Just a Click Away!
              </h2>{" "}
              <br />
              <p className="text-sm sm:text-base  ">
                Request a ride within your university campus in seconds. Safe,
                fast, and reliable transportation for students, faculty, and
                staff.
              </p>
              <a href="https://github.com/Danraph-Technologies/Ecocruise-apk/releases/download/v1.0.0/Ecocruise-App.apk" download>
                <button className=" hidden sm:block mb-44 py-2 px-3 rounded-3xl bg-white text-black font-semibold mt-4 border-2 border-white hover:bg-transparent hover:text-white hover:transition hover:duration-500 cursor-pointer">
                  Download App
                </button>
              </a>
              <a href="https://github.com/Danraph-Technologies/Ecocruise-apk/releases/download/v1.0.0/Ecocruise-App.apk" download>
                <button className=" block sm:hidden text-xs mb-40 py-2 px-3 rounded-3xl bg-white text-black font-semibold mt-4 border-2 border-white hover:bg-transparent hover:text-white hover:transition hover:duration-500 cursor-pointer">
                  Get the Danraph App
                </button>
              </a>
            </div>
          ...
          <div className="relative max-w-[400px] rounded-t-[120px] bg-white h-[410px] sm:h-[469px] shadow-md shadow-gray-600 ">
            <div className="pt-16 px-6">
              <h2 className="font-bold text-xl sm:text-3xl">
                Smart Transport, Hassle-Free Experience!
              </h2>
              <br />
              <p className="text-sm sm:text-base">
                Track shuttles in real-time, manage your ride history, and enjoy a
                cashless payment system—all in one platform.
              </p>
            </div>
          ...
          <div className="flex-wrap justify-center  lg-custom:justify-center lg-custom:mr-1  flex items-center gap-3 my-12 sm:my-28 mx-2 sm:2xl-[90px] p:justify-center ">
            <div className=" ">
              <div className="flex  gap-8 sm:gap-11 items-center -translate-y-2 md:-translate-y-11">
                <p className="border border-black text-base sm:text-3xl py-1 sm:py-2 px-4 rounded-full font-semibold">
                  Students
                </p>
              ...
              <div className="max-w-[850px]  lg:text-left text-center lg:max-w-[560px] lg-custom:max-w-[460px] ">
                <p className="font-semibold text-[27px] sm:text-[45px] lg-custom:text-[35px] py-5 ">
                  Smooth Rides, On Time
                </p>
                <p className="text-sm sm:text-lg lg-custom:text-base ">
                  Stay focused on what truly matters—teaching, research, and
                  administrative work—while we take care of your campus commute.
                  Whether you're heading to a lecture hall, faculty office, or an
                  important meeting, our transport system offers a reliable,
                  secure, and efficient way to move around campus without delays
                  or inconvenience.
                </p>
              </div>
            </div>
        ...
        <div className="p-3">
          <div className="max-w-[705px] sm:p-14 pb-4">
            <h2 className="text-[24px] sm:text-[40px] font-bold pb-[13px]">
              DanRalph EcoCruise Products
            </h2>
            <p className="sm:text-lg text-xs ">
              Smart, Efficient, and Eco-Friendly Campus Transportation at Your
              Fingertips.
            </p>
          </div>
          ...
          <div className="flex items-start flex-wrap justify-center gap-5">
            <div className=" max-w-[595px] border border-gray-400 rounded-xl">
              <img
                src={img6}
                alt="Rider/Customer App"
                className="w-full max-w-[595px] rounded-t-xl"
                loading="lazy"
              />
              <div className="max-w-[558px] my-2 mb-4 sm:mb-6 px-[12px] sm:px-[19px]">
                <h2 className="text-lg sm:text-2xl  font-medium py-2 sm:py-5">
                  Rider/Customer App
                </h2>
                <p className="text-[15px] sm:text-base font-normal underline ">
                  Book rides instantly, track shuttles in real time, and enjoy a
                  cashless, hassle-free campus transport experience.
                </p>
              </div>
            </div>
            ...
            <div className=" max-w-[595px] border border-gray-400 rounded-xl lg:mt-28 mt-0 medium:mt-0 ">
              ...
              <div className="max-w-[558px] my-2 mb-4 sm:mb-6 px-[12px] sm:px-[19px]">
                ...
                <p className="text-[15px] sm:text-base font-normal underline ">
                  Accept ride requests, navigate campus routes, and manage trips
                  efficiently with real-time updates and notifications.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-16 px-2">
          <div className=" max-w-[595px] border border-gray-400 rounded-xl lg:mt-28 mt-0 medium:mt-0 ">
            ...
            <div className="max-w-[558px] my-2 mb-4 sm:mb-6 px-[12px] sm:px-[19px]">
              ...
              <p className="text-[15px] sm:text-base font-normal underline ">
                Monitor rides, manage users and drivers, schedule shuttles, and
                optimize campus transport operations with ease.
              </p>
            </div>
          </div>
          ...
          <div>
            <div className="max-w-[549px] mt-4 xl:mt-24 foot:mt-4 ">
              ...
              <p className="font-normal sm:text-lg text-[15px]">
                ...
                bookings. Access your ride history, track ongoing trips, and
            ...
            <a href="https://github.com/Danraph-Technologies/Ecocruise-apk/releases/download/v1.0.0/Ecocruise-App.apk" download>
              <p className="sm:text-lg text-[14px] font-medium underline cursor-pointer hover:text-gray-700">
                Dont have a Danraph account? Sign up
              </p>
            </a>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-10 p-5 xl:gap-28 foot:mt-[15px] foot:gap-5 xl:mt-[130px] mt-[30px] mb-2 justify-left sm:justify-center items-center sm:items-start">
          <div className="max-w-[217px]">
            <img
              src={img1}
              alt="Danraph Logo"
              className="sm:max-w-[131px] max-w-[110px] w-full mb-3"
              loading="lazy"
            />
            <p className="font-normal sm:text-[16px] text-[13px]">
              Stay informed and in control with easy access to your recent rides,
              trip history, and account updates.
            </p>
          </div>
          ...
          <div className="min-w-[200px] sm:min-w-0 mt-0 sm:mt-5">
            ...
            <a href="https://github.com/Danraph-Technologies/Ecocruise-apk/releases/download/v1.0.0/Ecocruise-App.apk" download className="font-normal sm:text-lg text-base py-3 hover:text-blue-600 transition duration-300 cursor-pointer block">Book a Ride</a>
            <a href="https://github.com/Danraph-Technologies/Ecocruise-apk/releases/download/v1.0.0/Ecocruise-App.apk" download className="font-normal sm:text-lg text-base hover:text-blue-600 transition duration-300 cursor-pointer block">Recent Activities</a>
          </div>
